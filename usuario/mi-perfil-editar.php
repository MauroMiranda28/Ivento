...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    try {
        ...
        $stmt->execute();
        header("Location: mi-perfil.php?id=$_SESSION[id]");
    } catch(PDOException $e) {
        echo "No pudieron actualizarse los datos" . $e->getMessage();
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <style>
    body {
        background-image: url('../sesion/pexels-david-bartus-963278.jpg'); 
